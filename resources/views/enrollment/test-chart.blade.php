...
//                                      showDataLabels  last_point
// series[0] = DCP,             LAST    false           true    
// series[1] = GRAD,            LAST    false           true
// series[2] = TRAD-FT,         ALL     true            false
// series[3] = TRAD-FT,         LAST    false           true
// series[4] = Grand Total,     ALL     true            false

$data = [['label' => 'DCP', 'color' => '#5B9BD5', 'showDataLabels' => false,  'values' => $dcp_headcounts],
...
@endphp
    ...
    <div id="app">
        ...
        <line-chart-with-differing-data-labels
